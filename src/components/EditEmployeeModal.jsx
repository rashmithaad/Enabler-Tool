...
const EditEmployeeModal = ({ show, onHide, employee, onUpdate }) => {
    // Initialize with default values or empty strings
    const [updatedEmployee, setUpdatedEmployee] = React.useState({
        employee_name: '',
        employee_id: '',
        employee_status: '',
        country: '', // Default value set to Global
        region: '', // Initialize with appropriate default value
        division: '', // Initialize with appropriate default value
        entity_name: '', // Initialize with appropriate default value
        entity_id: '',
        category: '', // Initialize with appropriate default value
        fiscal_year_start: '', // Initialize with appropriate default value
        fiscal_year_end: '', // Initialize with appropriate default value
        employee_position: '',
        department_name: '', // Initialize with appropriate default value
        department_id: '',
        team_name: '',
        team_id: '',
        project_name: '',
    ...
    React.useEffect(() => {
        ...
        if (employee) {
            ...
            // Reset state when employee is null or undefined
            setUpdatedEmployee({
                employee_name: '',
                employee_id: '',
                employee_status: '',
    ...
    const handleChange = (e) => {
        ...
        const handleSubmit = () => {
            onUpdate(updatedEmployee); // Pass updatedEmployee to the onUpdate function for saving changes
        };
                ...
                <Modal.Body>
                        ...
                        <div className="col-sm-4">
                            <Form.Group controlId="formTeamName">
                                ...
                                <Form.Control
                                    type="text"
                                    name="team_name"
                                    value={updatedEmployee.team_name}
                                    onChange={handleChange}
                                    required
                                />
                            </Form.Group>
                    ...
                    <div className="row">
                        ...
                        <div className="col-sm-4">
                            ...
                            type="text"
                            name="project_name"
                            value={updatedEmployee.project_name}
                            onChange={handleChange}
                            required
                            />
                        </Form.Group>
                        ...
                        <div className="col-sm-4">
                            ...
                            type="text"
                            name="project_id"
                            value={updatedEmployee.project_id}
                            onChange={handleChange}
                            required
                        />
                        </Form.Group>
    ...
    <Form.Select
        ...
        value={updatedEmployee.employee_status}
        onChange={handleChange}
        required
    >
        ...
        <div className="row">
            ...
            <Form.Group controlId="formDivision">
                ...
                <Form.Select
                    name="division"
                    value={updatedEmployee.division}
                    onChange={handleChange}
                    className="scrollable-dropdown"
                    required
                >
        ...
        <div className="row">
            ...
            <Form.Group controlId="formEntity_Name">
                ...
                <Form.Select
                    name="entity_name"
                    value={updatedEmployee.entity_name}
                    onChange={handleChange}
                    required
                >
            ...
            <div className="col-sm-4">
                <Form.Group controlId="formEntity_Id">
                    ...
                    <Form.Control
                        type="text"
                        name="entity_id"
                        value={updatedEmployee.entity_id}
                        onChange={handleChange}
                        required
                    />
                </Form.Group>
            ...
            <Form.Group controlId="formCategory">
                ...
                <Form.Select
                    name="category"
                    value={updatedEmployee.category}
                    onChange={handleChange}
                    required
                >
        ...
        <div className="row">
            ...
            <Form.Group controlId="formFiscal_Year_Start">
                ...
                <Form.Select
                    ...
                    value={updatedEmployee.fiscal_year_start}
                    onChange={handleChange}
                    required
                >
            ...
            <Form.Group controlId="formFiscal_Year_End">
                ...
                <Form.Select
                    ...
                    value={updatedEmployee.fiscal_year_end}
                    onChange={handleChange}
                    required
                >
            ...
            <div className="col-sm-4">
                <Form.Group controlId="formEmployee_Position">
                    ...
                    <Form.Control
                        ...
                        value={updatedEmployee.employee_position}
                        onChange={handleChange}
                        required
                    />
                </Form.Group>
                ...
                <Modal.Footer>
                    <Button variant="secondary" style={{marginTop:"10px"}} onClick={onHide}>Close</Button>
                    <Button variant="primary" style={{marginTop:"10px"}} onClick={handleSubmit}>Save changes</Button>
                </Modal.Footer>
            </Modal>
        );
    };
